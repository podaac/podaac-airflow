...
| <a name="input_airflow_version"></a> [airflow\_version](#input\_airflow\_version) | Apache Airflow version used for Helm chart conditionals (must match the Airflow runtime in the Docker image). | `string` | `"3.2.1"` | no |
